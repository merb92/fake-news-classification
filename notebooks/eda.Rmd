...
ggplot(df_combined, aes(x = title_len, color = label)) +
  geom_histogram(alpha = 0.4, position = 'identity') +
  labs(title = 'Number of Characters in the News Title by Label',
...
ggplot(df_combined, aes(x = text_len, color = label)) +
  geom_histogram(alpha = 0.4, position = 'identity') +
  labs(title = 'Number of Characters in the News Text by Label',
       x = 'Number of Characters in Text') +
  theme(plot.title = element_text(hjust = 0.5))
```
...
ggplot(df_combined, aes(x = caps_in_title, color = label)) +
  geom_histogram(alpha = 0.4, position = 'identity') +
  labs(title = 'Number of Capital Letters in the News Title by Label',
       x = 'Number of Capital Letters in Title') +
  theme(plot.title = element_text(hjust = 0.5))
```
